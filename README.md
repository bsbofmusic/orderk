...
| Feature | Benefit |
|---|---|
| Single Rust binary | Small surface area and fast startup. The installed Linux x64 binary for v0.1.7 is 23,632,856 bytes, about 22.5 MiB, under a 30 MiB release-gate ceiling. |
